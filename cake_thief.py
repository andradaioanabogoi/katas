# INPUT: [(greutate in kg, valoare),..], capacitate in kilograme

# Overlapping subproblems:  finding its solution involves solving the same subproblem multiple times.
# Example: Fibonacci
# Learning: Start with base case examples
        ...
        for cake_weight, cake_value in cake_tuples:
            ...
            if cake_weight <= current_capacity:
                ...
                current_max_value = max(
                    max_value_using_cake, current_max_value)
...
print(cake_thief([(7, 160), (3, 90), (2, 15)], 20))
